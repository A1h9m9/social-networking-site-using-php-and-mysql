				...
				<div class="row">
					<div class="col-lg-12">
						<div class="logout-meta">
							...
							<p>
								Please <a href="login2.php" title="">Login</a> or <a href="signup.php" title="">Register</a> now to create your own profile and have access to all the Winku awesome features!
							</p>
						</div>
					</div>
				</div>
